...
//For facebook login
Route::post('saveUserInfoFacebook', array('middleware' => 'cors', 'uses' => 'CompanyLoginController@saveUserInfoFacebook'));
Route::post('updateOrderBygoodReceiptId', array('middleware' => 'cors', 'uses' => 'DeliveryController@updateOrderBygoodReceiptId'));
